...
export default function Button({ variant, children, ...props }: ButtonProps) {
    const variants = {
        primary: 'bg-primary text-white hover:bg-secondary disabled:bg-gray-400',
        ...
        grayOutline: 'bg-white hover:bg-gray-100 text-gray-700 border border-gray-400 disabled:text-gray-400 disabled:bg-white',
    }
