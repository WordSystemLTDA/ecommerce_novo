...
const PRIETO_KOUROS_FOOTER_CONFIG: FooterCompanyConfig = {
    ...
    enderecoResumo: 'Avenida Brasil, 1170 · Centro · Colorado - PR · 86.690-000',
    enderecoCompleto: 'Avenida Brasil, 1170 · Centro · Colorado - PR · 86.690-000',
    endereco: {
...
const URBAN_BOY_FOOTER_CONFIG: FooterCompanyConfig = {
    ...
    siteUrl: 'https://urbanboy.com.br',
    atendimento: 'Seg-Sex 08:00-18:00 / Sáb 08:00-13:00',
    lojaFisica: 'Bela Vista do Paraíso - PR · Seg-Sex 08:00-18:00 / Sáb 08:00-13:00',
    enderecoResumo: 'Avenida Independência, 1100 · Centro · Bela Vista do Paraíso - PR · 86.130-000',
    enderecoCompleto: 'Avenida Independência, 1100 · Centro · Bela Vista do Paraíso - PR · 86.130-000',
    endereco: {
